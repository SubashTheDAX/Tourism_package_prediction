...
Xtrain_path = "hf://datasets/TheHumanAgent/tourism-data/Xtrain.csv"
Xtest_path = "hf://datasets/TheHumanAgent/tourism-data/Xtest.csv"
ytrain_path = "hf://datasets/TheHumanAgent/tourism-data/ytrain.csv"
ytest_path = "hf://datasets/TheHumanAgent/tourism-data/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "final_tour_pkg_pred_model_v1.joblib"
    ...
    api.upload_file(
        path_or_fileobj="final_tour_pkg_pred_model_v1.joblib",
        path_in_repo="final_tour_pkg_pred_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
